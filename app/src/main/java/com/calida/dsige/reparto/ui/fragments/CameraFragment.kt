...
import com.calida.dsige.reparto.helper.ImageSaver
import com.calida.dsige.reparto.helper.Util
import com.calida.dsige.reparto.ui.activities.PreviewCameraActivity
...
//            }
    ...
    private val onImageAvailableListener = ImageReader.OnImageAvailableListener {
        backgroundHandler?.post(ImageSaver(it.acquireNextImage(), file, Util.getFecha()))
    }
    ...
    override fun onActivityCreated(savedInstanceState: Bundle?) {
        ...
        nameImg = Util.getFechaActualForPhoto(repartoId, 5) + ".jpg"
